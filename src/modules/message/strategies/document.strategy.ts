import { WhatsAppDocumentContent, WhatsAppPayload } from "@integrations/whatsapp/interfaces/whatsapp-message.interface";
...
export class DocumentMessageStrategy implements MessageStrategy {
  toWhatsAppPayload(to: string, content: WhatsAppDocumentContent): WhatsAppPayload {
